...
class TestJsonStore(JsonConfigServiceFixture):
    def test_can_store_user_data(
        self, sut: ConfigService, app_name: str, mock_file_util: FileUtil, user_home: Path, json_cfg_file: str, data: dict
    ):
...
class TestJsonUpdate(JsonConfigServiceFixture):
    def test_update_merges_deep(
        self, sut: ConfigService, app_name: str, mock_file_util: FileUtil, user_home: Path, user_config_factory, data: dict,
    ):
    ...
    def test_update_project_ignores_user_cfg_when_merging(
        self, sut: ConfigService, app_name: str, project_fu: FileUtil, project_config_factory, user_config_factory, data: dict,
    ):
        project_cfg = project_config_factory(data)
