...
class TestYamlSpecific(ConfigServiceFixture):
    def test_comments_are_ignored(self, sut: ConfigService, project_file_util, project_root: Path, app_name: str):
        ...
        cfg = sut.load(app_name=app_name, filename="with_comments.yaml", file_util=project_file_util)
