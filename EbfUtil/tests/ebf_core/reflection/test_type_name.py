...
class TestGetDescriptiveTypeName:
    ...
    class TestBasicTypes:
        """Test formatting of basic Python types."""
        ...
        def test_builtins(self) -> None:
            """Test formatting of built-in types."""
        ...
        def test_custom_classes(self) -> None:
            """Test formatting of user-defined classes."""
            class CustomClass:
                pass
    ...
    class TestGenericTypes:
        ...
        def test_bare_generics(self) -> None:
    ...
    class TestOptionalAndUnion:
        """Test formatting of Optional and Union types."""
    ...
    class TestCallable:
        ...
        def test_with_typed_params(self) -> None:
        ...
        def test_without_args_flag(self) -> None:
...
class TestIndividualFormatters:
    """Test individual formatter classes in isolation."""

    def test_optional_formatter(self) -> None:
    ...
    def test_union_formatter(self) -> None:
