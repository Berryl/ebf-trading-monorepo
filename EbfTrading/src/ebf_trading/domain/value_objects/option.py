...
class Option:
    ...
    Usage:
        ...
        # Display
        print(option) # "IBM 42.50P 2001-09-28"
        ```
    """
    underlying: Ticker
    strike: Strike
    ...
    def __str__(self) -> str:
        """
        Standard option notation: 'IBM 42.50P 2001-09-28'
        """
        type_char = 'C' if self.is_call else 'P'
        return f"{self.underlying.symbol} {self.strike.price.amount}{type_char} {self.expiration}"
